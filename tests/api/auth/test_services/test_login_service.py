...
class TestLoginService:
    ...
    async def test_login_success(self, test_db):
        ...
        req = LoginRequestSchema(email="login@test.com", password=raw_password).model_dump()
    ...
    async def test_login_failed_wrong_password(self, test_db):
        ...
        req = LoginRequestSchema(email="wrong_pwd@test.com", password="bad_password").model_dump()
    ...
    async def test_login_failed_user_not_found(self, test_db):
        req = LoginRequestSchema(email="nobody@test.com", password="any_password").model_dump()
