...
from src.api.auth.schemas.refresh_schema import RefreshRequest, RefreshResponse
...
class RefreshService:
    @staticmethod
    async def refresh(req_dict: RefreshRequest, db: AsyncSession) -> RefreshResponse:
        """
